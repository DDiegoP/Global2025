...
namespace QuickStart
{
    public class AndroidClient : NetworkBehaviour
    {
        ...
        {
            // Aqu� meter los valores con los que queremos tomar la snapshot de la referencia
        ...
        private void Start()
        {
            ...
            {
                Debug.LogError("NO TIENES ACELER�METRO");
            }
        ...
        void Update()
        {
            if(isLocalPlayer)
            {
                ...
                //    }
                //}
                // El cliente lanza el aceler�metro y eso
                if (HasAttitude()) {
